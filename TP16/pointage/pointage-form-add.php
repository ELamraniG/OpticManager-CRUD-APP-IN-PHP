...
<form method="POST" action="pointage-add.php">
	<fieldset style="border:1px solid lightgrey; padding: 10px; border-radius: 10px;">
		<legend style="background-color: lightblue; padding: 10px; border-radius: 10px; text-align: center; " class="form-control mb-5">Formulaire de saisi des pointages</legend>
		...
		<div class="form-group">
			...
			<textarea name=notes class="form-control" rows="3">Aucun</textarea>
		</div>
