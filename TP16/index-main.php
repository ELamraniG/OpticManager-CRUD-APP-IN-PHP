...
<div class="container">
	...
	<div class="alert alert-info">
		...
		<ul>
			<li>Gestion des services, des employés, des affectations aux services </li>
			<li>Gestion des pointages</li>
			<li>Traitement des rapports et statistiques</li>
		</ul>
	</div>
	</div>
</div>
...
if (isset($mdp))
{
	...
	if ($nbr_res == 1)
	{
		...
		redirection("service/service-list.php");
	}
	else
	{
