...
Public Class menu
    ...
    Private Sub infos_entreprise()
        ...
        Label4.Left = (panelpointage.Width - Label4.Width) / 2
    ...
    Public Sub afficher_lespanels()
        ...
        cmdsql()
        cpt = CInt(cmd.ExecuteScalar())
        cptpointage.Text = cpt.ToString
        cptpointage.Left = (panelpointage.Width - cptpointage.Width) / 2
    ...
    Private Sub affecter_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles affecter.Click, AffecttationDeSemployésToolStripMenuItem.Click
        Dim myForm As New affecter()
        myForm.ShowDialog()
        afficher_lespanels()
    End Sub

    Private Sub pauto_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles pauto.Click, PointageAutomatiqueToolStripMenuItem.Click
        Dim myForm As New pointageautomatique()
        myForm.ShowDialog()
        afficher_lespanels()
    End Sub

   
    Private Sub ConfigurationDeLapplicationToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ConfigurationDeLapplicationToolStripMenuItem.Click
        Dim myForm As New parametre()
        myForm.ShowDialog()
        afficher_lespanels()
    End Sub
    ...
    Private Sub pointageindividuel_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles pointageindividuel.Click
    ...
    Private Sub seconnecter_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles seconnecter.Click
        ...
        requete = "select utilisateur.*, nom, prenom from utilisateur, employe where" & _
                " utilisateur.idemploye = employe.idemploye " & _
        ...
        If data.Read() Then
            ...
            Else
                ...
                PointageToolStripMenuItem.Enabled = (pointage = "1")
                PointageIndividuelToolStripMenuItem.Enabled = (pointageindividuel = "1")
                PointageAutomatiqueToolStripMenuItem.Enabled = (pointageautomatique = "1")
                RapportsToolStripMenuItem.Enabled = (rapport = "1")
                RapportDePointageToolStripMenuItem.Enabled = (rapportdepointage = "1")
                LesPointagesDunEmployéToolStripMenuItem.Enabled = (lespointagesdunemploye = "1")
                LesPointagesDunServiceToolStripMenuItem.Enabled = (lespointagesdunservice = "1")
                ...
                ConfigurationDeLapplicationToolStripMenuItem.Enabled = (configurationdelapplication = "1")
