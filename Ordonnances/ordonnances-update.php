...
$parties = array();
$parties[] = "`idconsultation` = '" . $idconsultation . "'";
$parties[] = "`oeil` = '" . $oeil . "'";
$parties[] = "`sphere` = '" . $sphere . "'";
$parties[] = "`cylindre` = '" . $cylindre . "'";
$parties[] = "`axe` = '" . $axe . "'";
$parties[] = "`addition` = '" . $addition . "'";
$parties[] = "`typecorrection` = '" . $typecorrection . "'";

$r = "update `ordonnances` set " . implode(", ", $parties) . " where `idordonnance` = '" . $id . "'";
mysqli_query($con, $r);
