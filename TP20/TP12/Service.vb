...
Public Class Form1
    ...
    Private Sub Rechercher_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Rechercher.Click
        ...
        con.Close()
        If (DataGridView1.Rows.Count = 0) Then
            MsgBox("Ce service est INTROUVABLE", MsgBoxStyle.Information, "Message")
        End If
    End Sub
    ...
    Private Sub ImprimerLaListeDeTousLesServicesToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ImprimerLaListeDeTousLesServicesToolStripMenuItem.Click
