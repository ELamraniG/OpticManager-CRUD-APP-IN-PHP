...
$pdf->Cell(40, 10, 'Nom Utilisateur', 1, 0, 'C', true);
$pdf->Cell(60, 10, 'Nom Complet', 1, 0, 'C', true);
...
while ($data = mysqli_fetch_assoc($res)) {
    ...
    $pdf->Cell(40, 10, substr($data['nomutilisateur'], 0, 18), 1);
    $pdf->Cell(60, 10, substr($data['nomcomplet'], 0, 25), 1);
    $pdf->Cell(30, 10, substr($data['role'], 0, 12), 1);
    $pdf->Cell(20, 10, $data['actif'] ? 'Oui' : 'Non', 1);
    $pdf->Ln();
}
