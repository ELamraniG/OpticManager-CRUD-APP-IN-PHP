...
Public Class employe
    ...
    Public Sub afficher_employe(ByRef requete As String)
        ...
        Dim id, photo, ncin, nom, prenom, adresse, tel, email, ddn, ddr, fonction, specialite, salairenet, motdepasse As String
                Dim pic As Image
                While data.Read()
                    id = data(0).ToString
                    photo = data(1)
                    ...
                    fonction = data(10)
                    specialite = data(11)
                    salairenet = data(12).ToString
                    motdepasse = data(13)
                    pic = Image.FromFile("images/" + photo)
                    DataGridView1.Rows.Add(id, pic, ncin, nom, prenom, adresse, tel, email, ddn, ddr, fonction, specialite, salairenet, motdepasse)
                End While
